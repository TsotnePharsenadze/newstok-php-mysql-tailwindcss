...
<head>
    ...
    <title>Newstoks - Users index</title>
        ...
        <div>
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex gap-2">
                    <a href="Users-crud/deleted_users.php" class="bg-rose-500 text-white px-4 py-2 rounded-md">Deleted
                        Users
                        Records</a>
                    <a href="users-crud/create_users.php" class="bg-blue-500 text-white px-4 py-2 rounded-md">Create
                        Users</a>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td class="border p-4">
                                    <?php if ($_SESSION["user_type"] == 'admin' && $row["sts"] == "1") { ?>
                                    ...
                                    <a href="users-crud/delete_users.php?id=<?php echo $row['id']; ?>"
