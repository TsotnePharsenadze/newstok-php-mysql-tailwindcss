        ...
        <div class="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex">
                        <div class="flex">
                            <input type="radio" name="sts" id="sts1" class="p-2 mr-2 border rounded-md" value="1" <?php
                            echo $user["sts"] == 1 ? "checked" : "";
                            ?>>
                            <label for="sts1"><span
                                    class="bg-blue-100 text-blue-800 font-medium me-2 px-2.5 py-0.5 rounded uppercase">Pending</span></label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="sts" id="sts2" class="p-2 mr-2 border rounded-md" value="2" <?php
                            echo $user["sts"] == 2 ? "checked" : "";
                            ?>> <label for="sts2"><span
